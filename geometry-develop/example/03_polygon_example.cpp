...
int main(void)
{
    ...
    std::cout << "area: " << area(poly) << std::endl;//!!求面积

    // And the centroid, which is the center of gravity
    point_2d cent;
    centroid(poly, cent);//!!重心
    ...
    std::cout << "point in polygon:"
        << " p1: "  << boolstr(within(make<point_2d>(3.0, 2.0), poly))//!!判断点是否在poly内
